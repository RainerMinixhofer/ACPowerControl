#!/usr/bin/python3
# -*- coding:UTF-8 -*-
# pylint: disable=C0103,C0301,R0915,W0603
"""
...
def RAM_Address():
    """
    Specify row and column start and end addresses to the maximum range [0,127] and [0,127] respectively
    """
    Write_Command(0x15)
    Write_Data(0x00)
    Write_Data(0x7f)
